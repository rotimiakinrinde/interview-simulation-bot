...
st.title("Interview Simulation Chatbot")
...
if not st.session_state.setup_complete:
    ...
    st.session_state["company"] = st.selectbox(
        "Select a Company",
        ("Amazon", "Meta", "Google", "Synergy Wave", "Nestle", "LinkedIn", "Spotify"),
        index=("Amazon", "Meta", "Google", "Synergy Wave", "Nestle", "LinkedIn", "Spotify").index(st.session_state["company"])
    )
